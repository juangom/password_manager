...
import '../infra/repositories/password_metadata/drift_module.dart' as _i7;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i5.PasswordListRepository>(
      () => _i6.DriftPasswordListRepository(backend: get<_i7.DriftModule>()));
  gh.factory<_i8.StorageRepository>(() =>
      _i9.SecureStorageRepository(backend: get<_i10.SecureStorageModule>()));
  return get;
}

class _$DriftModule extends _i7.DriftModule {}
